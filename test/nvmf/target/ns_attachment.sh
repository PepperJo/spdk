...
$rpc_py nvmf_ns_attach_ctrlr $SUBSYSNQN 1 $HOSTNQN
check_active "0x1"

# hot detach and check inactive
$rpc_py nvmf_ns_detach_ctrlr $SUBSYSNQN 1 $HOSTNQN -hot
check_inactive "0x1"
disconnect
...
# hot + cold detach
$rpc_py nvmf_ns_detach_ctrlr $SUBSYSNQN 1 $HOSTNQN
check_inactive "0x1"
disconnect
...
$rpc_py nvmf_ns_attach_ctrlr $SUBSYSNQN 1 $HOSTNQN -hot
check_active "0x1"
disconnect
...
$rpc_py nvmf_ns_attach_ctrlr $SUBSYSNQN 1 $HOSTNQN -cold
check_inactive "0x1"
disconnect
...
$rpc_py nvmf_ns_detach_ctrlr $SUBSYSNQN 1 $HOSTNQN -cold
check_active "0x1"
disconnect
